...
### Set env vars
```bash
# example:  ETHEREUM_JSONRPC_HTTP_URL=https://testnet-msc.mindchain.info	
...
ETHEREUM_JSONRPC_HTTP_URL=https://testnet-msc.mindchain.info	
ETHEREUM_JSONRPC_TRACE_URL=https://testnet-msc.mindchain.info	
