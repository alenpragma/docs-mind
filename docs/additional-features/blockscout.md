...
### Set env vars
```bash
# example:  ETHEREUM_JSONRPC_HTTP_URL=https://rpc-testnet.Mind-chain.dog
export  ETHEREUM_JSONRPC_HTTP_URL=<your polygon-edge json-rpc endpoint>
# example: ETHEREUM_JSONRPC_TRACE_URL=https://rpc-testnet.Mind-chain.dog
...
ETHEREUM_JSONRPC_HTTP_URL=https://rpc-testnet.Mind-chain.dog
ETHEREUM_JSONRPC_TRACE_URL=https://rpc-testnet.Mind-chain.dog
