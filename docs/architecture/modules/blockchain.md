...
One of the main modules of the Mind-chainare **Blockchain** and **State**. <br />
...
The Blockchain Events are the original events that happen in Mind-chain, and they're later mapped to a Protocol Buffers message format for easy transfer.
:::