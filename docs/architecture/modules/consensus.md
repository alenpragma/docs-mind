...
The Mind-chainwants to maintain a state of modularity and pluggability. <br />
...
To start up IBFT, the Mind-chainfirstly needs to set up the IBFT transport:
...
The messages are meant to be used by validators. The Mind-chainthen subscribes to the topic and handles messages accordingly.
