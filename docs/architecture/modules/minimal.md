...
As mentioned before, Mind-chainis a set of different modules, all connected to each other.<br />
...
It acts as a central hub for all the services that run on the Mind-chain.
