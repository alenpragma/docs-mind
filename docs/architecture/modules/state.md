...
This enables the Mind-chainto get a specific Merkle trie, for a specific point in time. <br />
...
*state/executor.go* includes all the information needed for the Mind-chainto decide how a block changes the current
