...
Throughout the Mind-chain, when modules need to interact with the underlying data store, 
...
In order to make querying the LevelDB storage deterministic, and to avoid key storage clashing, the Mind-chainleverages
