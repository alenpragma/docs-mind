...
Unlike clients such as GETH, the Mind-chaindoesn't use reflection for the encoding.<br />
...
By manually defining these methods, the Mind-chaindoesn't need to use reflection. In *rlp_marshal.go*, you can find
