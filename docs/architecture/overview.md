...
This is something that is present in almost all parts of the Mind-chain. Below, you will find a brief overview of the
built architecture and its layering.

## Mind-chainLayering

![Mind-chainArchitecture](/img/Architecture.jpg)

## Libp2p

It all starts at the base networking layer, which utilizes **libp2p**. We decided to go with this technology because it
fits into the designing philosophies of Mind-chain. Libp2p is:
...
Mind-chainis designed to offer off-the-shelf pluggable consensus algorithms.
...
## Blockchain
The Blockchain layer is the central layer that coordinates everything in the Mind-chainsystem. It is covered in depth in the corresponding *Modules* section.
