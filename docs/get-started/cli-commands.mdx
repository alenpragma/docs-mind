...
This section details the present commands, command flags in the Mind-chain, and how they're used.
...
Used to specify the data directory used for storing Mind-chain Mind-chainclient data. Default: `./Mind-chain-chain`.
...
<Tabs>
  ...
  <TabItem value="example" label="Example">
    ...
    server --access-control-allow-origins "https://Mind-chain-docs.doge.technology"
...
<Tabs>
  ...
  <TabItem value="example" label="Example">
    ...
    server --log-to ./Mind-chain-testing.log
...
Sets the directory for the Mind-chaingenesis data. Default: `./genesis.json`.
...
Sets the name for the chain. Default: `Mind-chain`.
...
| secrets generate         | Generates a secrets manager configuration file which can be parsed by the Mind-chain   |
...
Sets the directory for the Mind-chaindata if the local FS is used.
...
Specifies the name of the node for on-service record keeping. Default: `Mind-chain-node`
...
<Tabs>
  ...
  <TabItem value="example" label="Example">
    ...
    backup --overwrite-file ./Mind-chain-snapshot.zst
